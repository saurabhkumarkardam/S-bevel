...
Use this [sample configuration file](https://github.com/hyperledger/bevel/blob/main/platforms/substrate/configuration/samples/network-sample-2.yaml) as a base. 


```yaml
--8<-- "platforms/substrate/configuration/samples/network-sample-2.yaml:7:15"
```
...
```yaml
--8<-- "platforms/substrate/configuration/samples/network-sample-2.yaml:18:30"
```
...
```yaml
--8<-- "platforms/substrate/configuration/samples/network-sample-2.yaml:32:38"
```
...
```yaml
--8<-- "platforms/substrate/configuration/samples/network-sample-2.yaml:40:55"
```
...
```yaml
--8<-- "platforms/substrate/configuration/samples/network-sample-2.yaml:66:80"
```
...
```yaml
--8<-- "platforms/substrate/configuration/samples/network-sample-2.yaml:84:96"
```
...
```yaml
--8<-- "platforms/substrate/configuration/samples/network-sample-2.yaml:98:173"
```
