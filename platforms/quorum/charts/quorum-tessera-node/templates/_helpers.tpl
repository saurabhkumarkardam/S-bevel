...
*/}}
{{- define "goquorum-tessera-node.name" -}}
...
*/}}
{{- define "goquorum-tessera-node.fullname" -}}
...
*/}}
{{- define "goquorum-tessera-node.chart" -}}
...
*/}}
{{- define "goquorum-tessera-node.tesseraURL" -}}
{{- $fullname := include "goquorum-tessera-node.fullname" . -}}
...
*/}}
{{- define "goquorum-tessera-node.clientURL" -}}
{{- $fullname := include "goquorum-tessera-node.fullname" . -}}
